                ...
                <div className="flex-grow flex flex-col justify-center items-center relative py-[20px] md:py-[60px]">
                    <div className="flex items-center gap-5 sm:gap-10">
                        <div className="bg-[#1E2238] rounded-2xl p-0.5">
                            <img
                                src={`/assets/vectors/rock-paper-scissor/${
                                    selectedChoice === 0
                                        ? "rock.png"
                                        : selectedChoice === 1
                                        ? "scissor.png"
                        ...
                        <div>
                            <img
                                src="/assets/vectors/rock-paper-scissor/vs.svg"
                                alt="vs"
                            />
                        </div>
                        <div>
                            <img
                                src="/assets/vectors/rock-paper-scissor/question.svg"
                                alt="question"
                            />
                        </div>
                    </div>
                    <div className="flex gap-5 sm:gap-10 mt-6">
                        <div>
                            ...
                            >
                                <img
                                    className="block"
                                    src="/assets/vectors/rock-paper-scissor/rock.png"
                                    alt="rock"
                                />
                ...
                <img src="/assets/vectors/topbar/eth.svg" alt="eth" className="w-[24px]" />
                        ...
                        <div>
                            ...
                            >
                                <img
                                    className="block"
                                    src="/assets/vectors/rock-paper-scissor/scissor.png"
                                    alt="scissor"
                                />
